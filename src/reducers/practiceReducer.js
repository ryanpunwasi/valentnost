import { START_PRACTICE, END_PRACTICE, CHECK_ANSWER, NEXT_QUESTION } from "../actions/types";
  ...
  switch (action.type) {
    case START_PRACTICE:
      return { 
        ...
        correct: 0, 
        incorrect: [], 
        currentElement: _.sample(action.payload), 
    ...
    case NEXT_QUESTION:
      ...
      while(true) {
        if(randomElementFromIncorrect && randomElementFromIncorrect.number !== action.payload.currentElement.number) {
